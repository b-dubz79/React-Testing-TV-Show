...
import { render, findByText, waitFor } from '@testing-library/react'
import App from './App'
import {fetchShow as mockFetchData} from './api/fetchShow'
...
mockFetchData.mockResolvedValueOnce(mockData)
    ...
    await waitFor(() => expect(getByTestId(/testerId/i)))
